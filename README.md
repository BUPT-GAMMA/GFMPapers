...
2. [arXiv 2023.05] **PRODIGY: Enabling In-context Learning Over Graphs.** [[pdf](https://arxiv.org/pdf/2305.12600)] [[code](https://github.com/snap-stanford/prodigy)] ![](https://img.shields.io/badge/Graph_Reconstruction/Supervised-EAD8D9) ![](https://img.shields.io/badge/Graph_Reconstruction/Supervised-EAD8D9)
...
14. [WWW 2023] **Graphprompt: Unifying pre-training and downstream tasks for graph neural networks.** [[pdf](https://dl.acm.org/doi/pdf/10.1145/3543507.3583386)] [[code](https://github.com/Starlien95/GraphPrompt)]
15. [KDD 2020] **Gcc: Graph contrastive coding for graph neural network pre-training.** [[pdf](https://arxiv.org/pdf/2006.09963.pdf)] [[code](https://github.com/THUDM/GCC)]
16. [NeurIPS 2020] **Graph contrastive learning with augmentations.** [[pdf](https://proceedings.neurips.cc/paper_files/paper/2020/file/3fe230348e9a12c13120749e3f9fa4cd-Paper.pdf)] [[code](https://github.com/Shen-Lab/GraphCL)]
17. [arXiv 2023.04] **AdapterGNN: Efficient Delta Tuning Improves Generalization Ability in Graph Neural Networks.** [[pdf](https://arxiv.org/pdf/2304.09595.pdf)]
18. [KDD 2023] **A Data-centric Framework to Endow Graph Neural Networks with Out-Of-Distribution Detection Ability.** [[pdf](http://shichuan.org/doc/150.pdf)] [[code](https://github.com/BUPT-GAMMA/AAGOD)]
19. [arXiv 2022.09] **Universal Prompt Tuning for Graph Neural Networks.** [[pdf](https://www.researchgate.net/profile/Taoran-Fang/publication/364110035_Prompt_Tuning_for_Graph_Neural_Networks/links/647abf7879a722376509c6a9/Prompt-Tuning-for-Graph-Neural-Networks.pdf)]
20. [arXiv 2023.02] **SGL-PT: A Strong Graph Learner with Graph Prompt Tuning.** [[pdf](https://arxiv.org/pdf/2302.12449.pdf)]
21. [arXiv 2020.01] **Graph-bert: Only attention is needed for learning graph representations.** [[pdf](https://arxiv.org/pdf/2001.05140.pdf)] [[code](https://github.com/anonymous-sourcecode/Graph-Bert)]
22. [NeurIPS 2020] **Selfsupervised graph transformer on large-scale molecular data.** [[pdf](https://proceedings.neurips.cc/paper/2020/file/94aef38441efa3380a3bed3faf1f9d5d-Paper.pdf)]
23. [arXiv 2023.05] **G-Adapter: Towards Structure-Aware Parameter-Efficient Transfer Learning for Graph Transformer Networks.** [[pdf](https://arxiv.org/pdf/2305.10329.pdf)]
